...
- GUI session editor: each save was wrapping leaf panes in an extra container via a recursive backend conversion, accumulating one extra nesting level per save and producing deeply nested YAML exports
